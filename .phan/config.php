...
return [
    ...
    // Automatically inferred from composer.json requirement for "php" of ">=7.1 <8"
    ...
    'directory_list' => [
        ...
        'vendor/jakub-onderka/php-var-dump-check/src',
        'vendor/phan/phan/src/Phan',
        'vendor/phpstan/phpstan-strict-rules/src',
        'vendor/phpstan/phpstan-webmozart-assert/src',
        'vendor/phpstan/phpstan/src',
        'vendor/phpunit/phpunit/src',
        'vendor/sensiolabs/security-checker/SensioLabs/Security',
